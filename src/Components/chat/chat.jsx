                        ...
                        loading ? <Loading/> :
                            <div>
                                ...
                                <div className="flex gap-5 absolute bottom-28 justify-center w-full">
                                    <button className='bg-blue-500 text-white px-5 py-2.5 min-w-60 rounded-2xl'>Изменить параметры</button>
                                    <button className="bg-emerald-600 text-white px-5 py-2.5  min-w-60 rounded-2xl">Начать новый чат</button>
                                </div>
